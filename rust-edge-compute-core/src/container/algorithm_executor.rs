...
impl ContainerizedAlgorithmExecutor {
    ...
    fn create_container_config(
        ...
        Ok(ContainerConfig {
            ...
            volumes: vec![], // TODO: Map volumes correctly
            resources: ResourceLimits {
                cpu_cores: Some(algorithm.resource_requirements.cpu_cores),
                memory_mb: Some(algorithm.resource_requirements.memory_mb),
                disk_mb: Some(algorithm.resource_requirements.disk_mb),
            },
